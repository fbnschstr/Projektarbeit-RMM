...
for f in files:
    if f.endswith('.png'):
       ...
       #Poren füllen mit dem Opening Befehl, über die Kernel kann eingestellt werden, wie viel schwarz gemacht wird von den Poren.
        ...
        #Berechnen der Poroesitaet
        poroesitaet = black_pixel/ges_pixel
        print("Poroesität der Probe",poroesitaet)
        dichte = white_pixel/ges_pixel
        print("Dichte der Probe",dichte)
        ...
        file_name_th1 = f"th_Por_{poroesitaet}_{image_name}"
